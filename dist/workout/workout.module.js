...
exports.WorkoutModule = WorkoutModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([workout_entity_1.Workout, exercise_entity_1.Exercise])],
        controllers: [workout_controller_1.WorkoutController, exercise_controller_1.ExerciseController],
        providers: [workout_service_1.WorkoutService, exercise_service_1.ExerciseService],
    })
], WorkoutModule);
