...
let ExerciseController = class ExerciseController {
    constructor(exerciseService, workoutService) {
        this.exerciseService = exerciseService;
        this.workoutService = workoutService;
    }
    async create(workoutId, createExerciseDto) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [Number, create_exercise_dto_1.CreateExerciseDto]),
